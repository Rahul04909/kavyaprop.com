<?php
/**
 * Dholera Responsive About Us Section Component
 * Developed by Expert UI/UX Designer & Developer
 */
?>
<!-- Load About Us Component Stylesheet -->
<link rel="stylesheet" href="assets/css/about.css">

<section class="dh-about-section" id="about-us">
  <div class="dh-about-container">
    <div class="dh-about-grid">
      
      <!-- Left Side: Visual Image Column -->
      <div class="dh-about-image-wrapper">
        <img src="assets/images/hero-bg.png" alt="Dholera Smart City Development Showcase" class="dh-about-image" loading="lazy">
      </div>
